            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{ $data->judul }}" name="judul" placeholder="Judul Berita">
                    </div>

                        <!-- /.form-group -->
                    <div class="form-group">
                        <label>Kategori</label>
                        <select class="form-control selectkategori" style="width: 100%;" name="category_id" id="select_kategori"></select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                       <label>Tags</label>
                        <div class="tags-default">
                            <input type="text" name="tags" value="{{ $data->tags }}" data-role="tagsinput" placeholder="add tags" /> </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btSave"><i class="ti-save-alt"></i> Save </button>
                </div>  
                </form>
            </div>
...
$(".selectkategori").empty().append('<option value="'+category_id+'">'+category_name+'</option>').val(category_id).trigger('change');
//select category
