                  ...
                  <div class="entry-image clearfix">
                      <div class="blog-p-post-you-tube">
                          <div class="cs-video [youtube, widescreen]">
                              {{-- <iframe width="560" height="315" src="https://www.youtube.com/embed/7zdEs3WNiog?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --}}
        ...
        function web_beritaterkini() {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (i = 0; i < jml; i++) {
                        url_detail = '{{ route("detail.page", ["urlext"=>":url","id"=>":id","title"=>":title"]) }}';
                        img = result[i].gambar;
                        ...
                        url_detail = url_detail.replace(':url', url_departemen).replace(':id', id_berita).replace(':title', slug);
                        
                        s = s + '<div class="col-lg-3 col-md-6 col-12">'+
                                    '<div class="box">'+
                                        '<a href="#" ><img class="card-img-top" style="object-fit:cover; object-position: center; width: 100%; max-height: 180px; margin-bottom: 1rem;" src="{{ URL::asset("uploadfile_news") }}/'+img+'" alt="'+img+'"></a>'+
                                        '<div class="box-body">'+ 
                                                '<div class="text-start">'+
                                                    '<h4 class="box-title">'+ titlesubtr +'</h4>'+
                                                    '<p class="mb-10 text-light fs-12"><i class="fa fa-calendar me-5"></i>'+result[i].created_at+'</p>'+
                                                    '<a href="'+url_detail+'" class="btn btn-outline btn-primary btn-sm">Read more</a>'+
                                                '</div>'+
                                            '</div>'+
                                        '</div>'+
                                    '</div>';
