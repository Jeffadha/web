                ...
                <div class="box-body">
                    {{-- <div class="box">
                        <div class="box-body ribbon-box bg-warning-light">
                            <div class="ribbon ribbon-warning"><i class="fa fa-info"></i> Informasi</div>
                            <p class="mb-0">Berikut merupakan list table data Berita Terkini. Silahkan klik tambah untuk menambah artikel baru.</p>
                        </div> <!-- end box-body-->
                    </div> --}}
                    <p><button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal_add"><i class="fa fa-plus"></i> Tambah</button></p>
