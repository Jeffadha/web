            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <h2 class="page-title text-white">DIPLOMA</h2>
                        <ol class="breadcrumb bg-transparent justify-content-center">
                            <li class="breadcrumb-item"><a href="#" class="text-white-50"><i
                                        class="mdi mdi-home-outline"></i></a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">diploma</li>
                        </ol>
                    </div>
                </div>
            </div>
					...
					<div class="box">
						<div class="fx-card-item">
							<div class="fx-card-avatar fx-overlay-1"> 
								@if ($dip->gambar)
                                <img src="/uploadfile_prodi/{{  $dip->gambar }}" alt="prodi">
                                @else
                                <img src="/images/no-image.png" alt="prodi"> 
                                @endif
								<div class="fx-overlay">
									<ul class="fx-info">
										<li><a class="btn btn-danger no-border" href="{{ route('detail_prodi_show', $dip->id_prodi) }}">View More</a></li>
									</ul>
								</div>
							</div>
							<div class="fx-card-content">
								<h4 class="box-title mb-0">{{ $dip->nama_prodi }}</h4>
								<h3 class="box-body mb-0">{{ $dip->degree }}</h3>
							</div>
						</div>
					</div>
				</div>
