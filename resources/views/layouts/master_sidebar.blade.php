...
/* Reduce vertical spacing */
	...
	padding: 4px 8px 4px 8px; font-size: 0.9em;
	}
  ...
  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="{{ route('dashboard') }}" class="logo">
		  <!-- logo-->
		  <div class="logo-lg">
			  <span class="light-logo"><img src="{{ URL::asset('images/logo_umuka_light_little.png') }}" alt="logo"></span>
			  <span class="dark-logo"><img src="{{ URL::asset('images/logo_umuka_dark_little.png') }}" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
...
<!-- ./wrapper -->
	...
	<div id="button-home">
		<a id="chat-circle" href="#" class="waves-effect waves-circle btn btn-circle btn-lg btn-outline btn-warning l-h-70" ><span class="fa fa-home fs-30"><span class="path1"></span><span class="path2"></span></span></a>
	</div>
